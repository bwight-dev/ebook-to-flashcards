...
def main():
    ...
    try:
        ...
        config = AppConfig()        # Set debug logging if enabled
        ...
        if config.generate_flashcards:
            ...
            print(f"🗂️ Flashcard generation: DISABLED")        # Initialize components following dependency injection
        ...
        print("\n🔍 Discovering and processing ebook files...")
        ...
        if books:
            ...
            for book_info in summary["books"]:
                ...
                print(
                    f"    Chapters: {book_info['chapters']}, Words: {book_info['words']:,}"
                )
            ...
            if all_flashcards:
                ...
                for book_title, flashcards in all_flashcards.items():
                    if flashcards:
                        ...
                        for i, card in enumerate(
                            ...
                            print(
                                f"    {i}. {card.front[:60]}{'...' if len(card.front) > 60 else ''}"
                            )
                        if len(flashcards) > 3:
                ...
                if not config.openai_api_key:
                    ...
                    print(
                        "    Check the logs for more details about why flashcards weren't generated."
                    )
        else:
